        ...
        <div class="banner-container">
            <div class="banner-boxslider">
                <div class="banner-boxslider-content">
                    <div class="banner-boxslider-content-title s52" id="slide1">
                        ...
                        <div class="banner-boxslider-content-all s20">
                            ...
                            <img src="assets/panahbunder.svg" alt="">
                        </div>
                    </div>
                ...
                <div class="upcomingmatch">
                    <div class="upcomingmatch-button" onclick="changeupcoming(0)" id="upcomingback"><img src="assets/panahmundur.svg" alt="" class="upcomingmatch-button-icon"></div>
                            ...
                            <div class="upcoming-boxslider-content-page" id="upcoming-match1">
                                <div class="upcomingmatch-box">
                                    <div class="upcomingmatch-box-content s12">
                                        <img src="assets/logalengkap.svg" alt="" class="upcomingmatch-box-logo">
                                        <div class="upcomingmatch-box-match s32">
                                            <img src="assets/logotim.svg" alt="" class="upcomingmatch-box-match-logo">
                                            <p>VS</p>
                                            <img src="assets/logotim.svg" alt="" class="upcomingmatch-box-match-logo">
                                        </div>
                    ...
                    <div class="upcomingmatch-button" onclick="changeupcoming(9)" id="upcomingnext"><img src="assets/panahmaju.svg" alt="" class="mcicon"></div>
                </div>
            </div>
        </div>
    </div>
    <div class="neswntable">
            ...
            <div class="fixtures">
                <div class="fixtures-title">
                    ...
                    <div class="fixtures-knob-content">
                        <img src="assets/panahmundur.svg" alt="">
                        <p>MATCHDAY 2</p>
                        <img src="assets/panahmaju.svg" alt="">
                    </div>
                </div>
                <div class="fixtures-content">
                    <div class="fixtures-content-grid">
                        <div class="timmatch jc-end">
                            <p>TOTTENHAM</p>
                            <img src="assets/logotim.svg" alt="" class="timmatch-logo">
                        </div>
                ...
                <div class="table-content">
                    <div class="table-content-left">
                        ...
                        <div class="table-content-club">
                            <img src="assets/logotim.svg" alt="" class="table-content-logo">
                            <p>LIVERPOOL</p>
                        </div>
                    </div>
                    <div class="table-header-right">
        ...
        <div class="akanan">
            <div class="akanama s48">
                ...
                <div class="vial s20">
                    <p>VIEW ALL</p>
                    <img src="assets/vial.svg" alt="">
                </div>
            </div>
            <div class="akafull">
                <div class="imagebox">
                    <img src="assets/fot1.png" alt="gambar" class="foto">
                </div>
            ...
            <div class="akabawah">
                <div class="bag1">
                    <div class="card">
                        <div class="imagebox2">
                            <img src="assets/fot2.jpg" alt="gambar" class="foto2">
                        </div>
        ...
        <div class="highlight s20">
            <div class="highlightnav">
                ...
                <div class="highlightnav-right">
                    <p>VIEW ALL</p>
                    <img src="assets/panahmajubuletbiru.svg" alt="">
                </div>
            </div>
            <div class="highlightcontent">
                <div class="highlightcontent-card">
                    <div class="bluebox">
                        <img src="assets/highlight1.png" alt="">
        ...
        <div class="gallery s20">
            ...
            <div class="gallerycontent">
                <div class="wrapper">
                    ...
                    <div class="carousel">
                      <img src="assets/gal-1.png" alt="img" draggable="false">
                      <img src="assets/gal-2.png" alt="img" draggable="false">
                      <img src="assets/gal-3.png" alt="img" draggable="false">
                      <img src="assets/gal-1.png" alt="img" draggable="false">
                      <img src="assets/gal-2.png" alt="img" draggable="false">
                      <img src="assets/gal-3.png" alt="img" draggable="false">
                      <img src="assets/gal-1.png" alt="img" draggable="false">
