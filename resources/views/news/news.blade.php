    ...
    <div class="line2-column1 bg-[#FFFFFF] border border-solid border-[#E5E5E5] rounded-md h-[300px] relative">
        <a href="/news/{{ $p->id }}">
            <div class="image overflow-hidden rounded-[6px_6px_0_0]">
                <img src="{{ '../storage/news/'.$p->gambar_berita }}" class="object-fill w-full h-fit transform-gpu transition-transform duration-300 ease-out hover:scale-125" alt="gambar-news">
                <div class="line2-column1 bg-[#FFFFFF] rounded-b-lg h-[140px] absolute bottom-0">
                    ...
                    <p class="absolute bottom-3 left-4 font-['Roboto'] text-[#737373] text-[14px] font-medium">{{ $p->created_at->format('d M Y') }}</p>
                </div>
            </div >
        </a>
    </div>
